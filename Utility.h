...
class Utility{
    ...
    public:
        ...
        double compute_distance(T1* from, T2* to);  //compute the distance between from and to        void ue_set_connected(user* ue, vector <base_station*> bs, int n_bs);  //set to which BS the UE gets connected for simulation initialization
 ...
 */
template <typename T1, typename T2>
double compute_distance(T1* from, T2* to){
...
template <typename T1, typename T2>
double compute_delay(T1* from, T2* to, int transmission_channel){
